...
本交付包按任务书改为 MATLAB/Simulink 开发，不使用 Vitis。实验结果来自本机 MATLAB R2020a 实际运行，不手写或伪造数据。
...
```powershell
& 'D:\Program Files\MATLAB\R2020a\bin\matlab.exe' -batch "cd('D:\resource\湘潭大学\dsp'); addpath('matlab'); run_all_simulations"
...
- DOCX 校验：正文 9501 个中文字符，14 条参考文献引用，5 个表格，无乱码替换字符
